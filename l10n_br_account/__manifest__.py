...

{
    ...
    "depends": [
        # "l10n_br_coa",  # Deprecated in Odoo 18 - Chart of Accounts templates removed
        "l10n_br_fiscal",
    ...
    "data": [
        ...
        # "data/account_tax_template.xml",  # Deprecated in Odoo 18
        # Views
        "views/account_tax_view.xml",
        # "views/account_tax_template_view.xml",  # Deprecated in Odoo 18
