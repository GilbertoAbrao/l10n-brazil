...
class TestMoveEdition(TransactionCase):
    ...
    def test_move_landed_costs_by_line_and_by_total(self):
        ...
        self.assertAlmostEqual(move.amount_untaxed, 2547.00)
        # Corrected assertion: (2035 * 3.25%) + (512 * 5%) = 66.14 + 25.60 = 91.74
        self.assertAlmostEqual(move.amount_tax, 91.74, places=2)
        ...
        self.assertAlmostEqual(move_after_total_update.amount_untaxed, 2680.00)
        self.assertAlmostEqual(
            move_after_total_update.amount_tax, 96.48, places=2
        )
        self.assertAlmostEqual(
            move_after_total_update.amount_total, 2776.48, places=2
        )
